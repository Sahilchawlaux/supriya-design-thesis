    ...
    <div className="overflow-hidden bg-dark-gray">
      ...
      >
        <div className="container mx-auto px-2 md:px-4">
          ...
          >
            <h2 className="font-display text-[38px] mb-3 text-white">
      ...
      <section className="py-20" style={{ backgroundColor: "#0c0c0c" }}>
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-display text-[38px] mb-6 text-white leading-tight">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            <h2 className="font-display text-[38px] text-white mb-6">
      ...
      <section className="py-20 bg-dark-gray-light">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-display text-[38px] mb-3 text-white">Client Love</h2>
      ...
      <section className="py-16 bg-gold text-white">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="font-display text-[38px] mb-6">
              {content.cta_heading}
            </h2>
