    ...
    <div className="bg-dark-gray">
      ...
      <section className="relative h-[50vh] min-h-[420px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="font-serif text-[32px] mb-6 text-white tracking-tight">
            Contact Us
          </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="text-center">
              <h2 className="font-serif text-[32px] mb-5">Get in Touch</h2>
      ...
      <section className="py-20 bg-dark-gray-light">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h2 className="font-serif text-[32px] mb-3">Frequently Asked Questions</h2>
