    ...
    <div>
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden py-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="font-display text-[38px] mb-6 text-white">{content.heading}</h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="font-display text-[38px] mb-6">Meet {content.founderName}</h2>
      ...
      <section className="py-20 bg-dark-gray-light">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-[38px] mb-3 text-white">Our Mission</h2>
      ...
      <section className="py-20 bg-dark-gray">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-display text-[38px] mb-3 text-white">Terms and Conditions</h2>
      ...
      <section className="py-16 bg-gold text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-[38px] mb-6">Ready to Start Your Design Journey?</h2>
